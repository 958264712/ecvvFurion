...
import { pYYOtherWarehouseReceiptsPage } from '/@/api/modular/main/financial.ts';
...
function Imports(file: any) {
	...
	axios
		.post((import.meta.env.VITE_API_URL as any) + `/api/pYYOtherWarehouseReceipts/import`, formData)
		.then((res) => {
