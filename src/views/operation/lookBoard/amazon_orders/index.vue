	...
	<div>
			...
			<el-form :model="queryParams" ref="queryForm" :inline="true">
				...
				<el-form-item label="订单时间">
					<el-date-picker style="width: 250px;" start-placeholder=" 开始时间" end-placeholder="结束时间" type="daterange"
						v-model="queryParams.OrderTime" format="YYYY-MM-DD" />
				</el-form-item>
		...
		<el-card class="full-table" shadow="hover" style="margin-top: 8px">
			...
			<el-table :data="tableData" size="lagre" style="width: 100%" v-loading="loading" tooltip-effect="light"
				...
				<el-table-column prop="productTitle" label="Product Title" width="130" sortable align="center"
					show-overflow-tooltip="" />
				<el-table-column prop="brand" label="Brand" width="100" sortable align="center" show-overflow-tooltip="" />
				<el-table-column prop="shippedRevenue" label="Shipped Revenue" width="170" sortable align="center"
					show-overflow-tooltip="" />
				<el-table-column prop="shippedCOGS" label="Shipped COGS" width="150" sortable align="center"
					show-overflow-tooltip="" />
				<el-table-column prop="shippedUnits" label="Shipped Units" width="150" sortable align="center"
					show-overflow-tooltip="" />
				<el-table-column prop="customerReturns" label="Customer Returns" width="170" sortable align="center"
					show-overflow-tooltip="" />
				<el-table-column prop="site" label="站点" sortable align="center" show-overflow-tooltip="" />
				<el-table-column prop="beginTime" label="订单开始时间" width="150" sortable align="center"
					show-overflow-tooltip="" />
				<el-table-column prop="endTime" label="订单截止时间" width="150" sortable align="center"
					show-overflow-tooltip="" />
				<el-table-column prop="createTime" label="导入时间" width="150" sortable align="center"
					show-overflow-tooltip="" />
