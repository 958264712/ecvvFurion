...
<template>
  <div>
    ...
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item label="在生产最近交货期">
          <el-date-picker placeholder="请选择在生产最近交货期" value-format="YYYY/MM/DD" type="daterange" v-model="queryParams.latestDeliveryDateRange" />
          
        </el-form-item>
        <el-form-item label="在生产最远交货期">
          <el-date-picker placeholder="请选择在生产最远交货期" value-format="YYYY/MM/DD" type="daterange" v-model="queryParams.farthestDeliveryDateRange" />
        ...
        <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAddOFSProductNameDetail" v-auth="'oFSProductNameDetail:add'"> 新增 </el-button>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table
        ...
        <el-table-column type="index" label="序号" width="55"  align="center"/>
         ...
         <el-table-column prop="productionCycle" label="生产周期"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="logisticsCycle" label="物流周期"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="negotiationCycle" label="谈判周期"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="inventoryDubai" label="在迪拜库存"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="inDomesticInventory" label="在国内库存"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="inTransitInventory" label="在途库存"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="inProductionInventory" label="在生产库存"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="latestDeliveryDate" label="在生产最近交货期"   width="170px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="farthestDeliveryDate" label="在生产最远交货期"   width="170px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="fromToday" label="距离今天"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="averageSales7Days" label="近7天日均销量"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="averageSales30Days" label="近30天日均销量"   width="170px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="numberOfDaysInWarehouse" label="在库可售天数"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="comprehensiveNumberOfDays" label="综合可售天数"   width="150px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="purchaseReturnCycle" label="采购返单结余周期"   width="170px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="sellEarlyWarning" label="在迪拜库销售预警"   width="170px"  align="center" sortable show-overflow-tooltip="" />
         <el-table-column prop="purchaseReturnWarning" label="采购返单预警"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column label="操作" width="140"  align="center" sortable fixed="right" show-overflow-tooltip="" v-if="auth('oFSProductNameDetail:delete')">
          <template #default="scope">
            ...
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delOFSProductNameDetail(scope.row)" v-auth="'oFSProductNameDetail:delete'"> 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
	...
	/>
      <editDialog
			    ref="editDialogRef"
			    :title="editOFSProductNameDetailTitle"
