...
import { exprotShipmentConfrmationPage, exprotShipmentConfrmationDeliveryList,exprotShipmentConfrmationDeliveryListOld,getFileStream,getExportRecordPage } from '/@/api/modular/main/aSINBasicData.ts';
...
const defaultValuesParams = ref<any>({ site: 'SA' });
...
const exportDeliverList = async (id: number | undefined = undefined, time: string | undefined = undefined) => {
	...
	const api = time && moment(time).isBefore('2024-12-03') 
...
<template>
	<div class="poDatel-container">
		...
		<importDialog ref="importDialogRef" multiple title="Import PO Shipment Confirmation" :ifExcelBol="true" :tableAddress="tableAddress" area="EN" :url="url" @reloadTable="handleQuery" @startTimer = "startTimer" />
