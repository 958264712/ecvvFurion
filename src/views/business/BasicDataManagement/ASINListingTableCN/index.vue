					...
					<el-popover :visible="visibleTextarea2" placement="bottom" :width="250">
						...
						<div style="text-align: right; margin-top: 20px">
							...
							<el-button type="primary"
								@click="handleConfirm()">{{ area == 'CN' ? '确定' : 'Confirm' }}</el-button>
						</div>
						<template #reference>
							<el-input v-model="aSIN" clearable=""
								:placeholder="area == 'CN' ? '请输入,点击展开可输多个' : 'Please input, click to expand to input multiple'"
								@clear="clearAsin">
								<template #suffix>
									<el-icon class="el-input__icon">
										<ArrowDownBold @click="visibleTextarea2 = !visibleTextarea2"
				...
				<el-form-item>
					<el-button-group>
						<el-button type="primary" icon="ele-Search"
							@click="handleQuery">{{ area == 'CN' ? '查询' : 'Search' }}
						</el-button>
		...
		<el-card class="full-table" shadow="hover" style="margin-top: 8px">
			<div class="settingf">
				<el-button type="primary" icon="ele-Plus"
					@click="openAddASINBasicData">{{ area == 'CN' ? '新增' : 'Add' }}
				</el-button>
				...
				<el-button :loading="loading3" type="primary" @click="openimportDialog">Import ASIN Listing
					Table</el-button>
				<!-- </el-upload> -->
				...
				<el-button style="margin-left: 10px;" type="primary" :disabled="selectedRows?.length <= 0"
					@click="ASINBatchDelete">批量删除</el-button>
				<!-- <div class="setting">
			...
			<div style="margin-top: 5px; display: flex; justify-content: space-between">
				...
				<tabDragColum :data="TableData" :name="`TableData`" :tagInfo="true" :area="area"
			...
			<importDialog ref="importDialogRef" :errorData="errorData" :excelName="excelName" :ifExcelBol="true"
				:exportUrl="'/api/aSINListingTable/exportError/'" :tableAddress="tableAddress" :area="area" :url="url"
...
const openimportDialog = () => {
	...
	excelName.value = '产品上架记录表-' + area.value
	tableAddress.value = (import.meta.env.VITE_API_URL as any) + '/upload/TableAddress/产品上架记录表-' + area.value + '.xlsx'
