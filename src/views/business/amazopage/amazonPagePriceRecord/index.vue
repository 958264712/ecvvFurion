<script lang="ts" setup name="amazonPagePriceRecord">
import { ref } from "vue";
import { ElMessageBox, ElMessage } from "element-plus";
import { auth } from '/@/utils/authFunction';
// import editDialog from './component/editDialog.vue'
import { pageAmazonPagePriceRecord, deleteAmazonPagePriceRecord } from '/@/api/modular/main/amazonPagePriceRecord';
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageAmazonPagePriceRecord(Object.assign(queryParams.value, tableParams.value));
...
// 删除
const delAmazonPagePriceRecord = (row: any) => {
  ElMessageBox.confirm(`确定要删除吗?`, "提示", {
    ...
    .then(async () => {
      await deleteAmazonPagePriceRecord(row);
      handleQuery();
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table :data="tableData" size="lagre" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id"
        ...
        <el-table-column prop="adjustMoney" label="AdjustMoney" align="center" sortable width="150"
          show-overflow-tooltip="" />
        <el-table-column prop="adjustedPercentage" label="AdjustedPercentage" align="center" sortable width="190"
          show-overflow-tooltip="" />
        ...
        <el-table-column prop="myBuyboxSum" label="MyBuyboxSum" align="center" sortable width="150"
          show-overflow-tooltip="" />
        <el-table-column prop="myShippingValue" label="MyShippingValue" align="center" sortable width="170"
          show-overflow-tooltip="" />
        <el-table-column prop="remark" label="Remark" align="center" sortable width="150" show-overflow-tooltip="" />
