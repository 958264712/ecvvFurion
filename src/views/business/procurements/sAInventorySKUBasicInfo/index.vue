	...
	<div class="oFSStockWarning-container">
		...
		<el-card class="full-table" shadow="hover" style="margin-top: 8px">
			<div>
				...
				<el-form-item style="width: 300px;float: left;margin-left: 10px;"
						label="RMB/汇率"
						:rules="[
							{
								required: true,
					...
					>
						...
						<el-button
							...
							@click="setItem('setexchangeRate',setexchangeRate)"
							>{{ setexchangeRate ? '设置' : '保存' }}</el-button
						>
					</el-form-item>
			</div>
			...
			<el-table :data="tableData" size="lagre" style="width: 100%" v-loading="loading" tooltip-effect="light"
				row-key="id" border="">
				<el-table-column prop="inventorySKU1" align="center" label="库存SKU" width="150" show-overflow-tooltip="" />
				<el-table-column prop="goodsName" align="center" label="产品名称" width="150" show-overflow-tooltip="" />
				<el-table-column prop="purchasingCountry" align="center" label="采购国" width="150" />
				<el-table-column prop="totalQuantityShipped" align="center" label="发货总数量" width="150" />
				<el-table-column prop="totalProcurementCost" align="center" label="采购总成本" width="150" />
				<el-table-column prop="totalCostOfCNHeadProcess" align="center" label="CN头程总成本" width="150" />
				<el-table-column prop="comprehensiveProcurementUnitPrice" align="center" label="综合采购单价" width="150" />
				<el-table-column prop="monetaryUnit" label="货币单位" align="center" width="150" />
				<el-table-column prop="comprehensiveProcurementUnitPriceAED" align="center" label="综合采购单价AED" width="170" />
				<el-table-column prop="comprehensiveSupplyPriceAED" align="center" label="综合供货价AED" width="170" />
				<el-table-column prop="comprehensiveInitialUnitPriceAED" align="center" label="综合头程单价AED" width="170" />
				<el-table-column prop="quantityShippedInThePast90Days" align="center" label="近90天发货数量" width="170" />
				...
				<el-table-column prop="purchaseUnitPriceAEDInThePast90Days" align="center" label="近90天采购单价AED"
					width="190" />
				<el-table-column prop="lastYearcomprehensivePriceAED" align="center" label="去年综合采购单价AED" width="190" />
				<el-table-column prop="salesAttributes" align="center" label="销售属性" width="190" />
				<el-table-column prop="productCAT" align="center" label="产品CAT" width="190" />
			</el-table>
