<script lang="ts" setup="" name="uSAInventorySKUBasicInfo">
import { ref } from 'vue';
import { ElMessageBox, ElMessage } from 'element-plus';
import other from '/@/utils/other.ts';
import { uSAGetInventorySKUBasicInfo, uSAExportInventorySKUBasicInfo, getInterestRate, updateConfig } from '/@/api/modular/main/uAE_ProcurementDetails.ts';
...
const getData = () => {
	const param = {
		code: 'sys_USA_exchange_rate',
		page: 1,
		pageSize: 1,
	};
	getInterestRate(param).then((res) => {
...
const handleQuery = async () => {
	...
	var res = await uSAGetInventorySKUBasicInfo(Object.assign(queryParams.value, tableParams.value));
...
function Export() {
	loading.value = true;
	uSAExportInventorySKUBasicInfo(Object.assign(queryParams.value, tableParams.value, { exchangeRate: exchangeRate.value.value })).then((res: any) => {
		loading.value = false;
...
<template>
	<div class="oFSStockWarning-container">
		...
		<el-card class="full-table" shadow="hover" style="margin-top: 8px">
			<div>
				<el-button style="float: left" @click="Export" type="primary" size="small" v-auth="'uSAInventorySKUBasicInfo:export'">导出</el-button>
				<el-form-item
				...
				>
					...
					<el-button type="primary" style="marginleft: 10px" @click="setItem('setexchangeRate', setexchangeRate)">{{ setexchangeRate ? '设置' : '保存' }}</el-button>
				</el-form-item>
			</div>
			...
			<el-table :data="tableData" size="lagre" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
				...
				<el-table-column prop="comprehensiveSupplyPriceAED" align="center" label="综合供货价USD" width="85" show-overflow-tooltip="" />
				<el-table-column prop="comprehensiveProcurementUnitPriceAED" align="center" label="综合采购单价USD" width="85" show-overflow-tooltip="" />
				<el-table-column prop="comprehensiveInitialUnitPriceAED" align="center" label="综合头程单价USD" width="90" show-overflow-tooltip="" />
				...
				<el-table-column prop="totalProcurementCostInThePast90DaysAED" align="center" label="近90天总采购成本USD" width="100" show-overflow-tooltip="" />
				<el-table-column prop="purchaseUnitPriceAEDInThePast90Days" align="center" label="近90天总采购单价USD" width="100" show-overflow-tooltip="" />
				<el-table-column prop="lastYearcomprehensivePriceAED" align="center" label="去年综合采购单价USD" width="100" show-overflow-tooltip="" />
