...
import { pageUAE_ProcurementDetails, deleteUAE_ProcurementDetails, UAEImport } from '/@/api/modular/main/uAE_ProcurementDetails.ts';
...
function Imports(file: any) {
	...
	UAEImport(formData).then((res: any) => {
	...
	<div class="uAE_ProcurementDetails-container">
		...
		<el-card class="full-table" shadow="hover" style="margin-top: 8px">
			...
			<el-table :data="tableData" size="lagre" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
				...
				<el-table-column prop="warehouseAuditTime" label="仓库审核时间" align="center" width="100" show-overflow-tooltip="" />
				...
				<el-table-column label="操作" width="140" align="center" fixed="right" v-if="auth('uAE_ProcurementDetails:edit') || auth('uAE_ProcurementDetails:delete')">
					<template #default="scope">
						<el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditUAE_ProcurementDetails(scope.row)" v-auth="'uAE_ProcurementDetails:edit'"> 编辑 </el-button>
						<el-button icon="ele-Delete" size="small" text="" type="primary" @click="delUAE_ProcurementDetails(scope.row)" v-auth="'uAE_ProcurementDetails:delete'"> 删除 </el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination
