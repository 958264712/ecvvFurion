...
const solveAddTagsView = async (path: string, to?: RouteToFrom) => {
	...
	if (current.length <= 0) {
		...
		// console.log(matched)
		// if(matched){
		// 	findItem.meta.title=findItem.query.name
		// 	console.log(21)
		// }
...
const closeCurrentTagsView = (path: string) => {
	if (path == '/business/BasicDataManagement/ASINListingTableCN/ASINListingTableCNAdd-CN' || path == '/business/BasicDataManagement/ASINListingTableCN/ASINListingTableCNAdd-LOCAL') {
		// store.$patch({ queryForm: {}});
