  ...
  <div class="amazonPagePriceRecord-container">
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table :data="tableData" size="lagre" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column prop="adjustedPercentage" label="AdjustedPercentage" align="center" sortable width="190" show-overflow-tooltip="" />
        ...
        <el-table-column prop="myShippingValue" label="MyShippingValue" align="center" sortable width="170" show-overflow-tooltip="" />
