    ...
    <el-card>
      <div class="table-page-search-wrapper">
        ...
        <el-card class="full-table" shadow="hover"   style="margin-top: 8px">
          <el-table :data="tableData"  size="large" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="" >
            <el-table-column type="index" label="序号" width="80" align="center" sortable/>
            <el-table-column prop="commodityCode" label="商品编码"   width="130"   align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="productName" label="商品名称"  width="130"  align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="finishedProductInventory" label="成品库存" width="130"   align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="quantityOfOrdersPlaced" label="已下单数量" width="130"  align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="commodityCategory" label="商品类别"  width="130"  align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="warehouseName" label="仓库名称" width="130"   align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="specificationAndModel" label="规格型号" width="130"   align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="brand" label="品牌"  width="130"  align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="sKUCoding" label="Sku编码"  width="130"  align="center" sortable show-overflow-tooltip="" />
            <el-table-column prop="defaultSupplier" label="默认供应商" width="130"   align="center" sortable show-overflow-tooltip="" />
            ...
            <el-table-column prop="belongToTheTeam" label="所属团队" width="130"   align="center" sortable show-overflow-tooltip="" />
