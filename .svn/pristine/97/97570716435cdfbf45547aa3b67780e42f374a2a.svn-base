  ...
  <div>
    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      <el-table :data="tableData" size="lagre" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column prop="dateOfOrderIssued" label="下单日期"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="dateOfDelivery" label="交货日期"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        ...
        <el-table-column prop="executionStatus" label="执行状态"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="offStatus" label="关闭状态"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="paymentStatus" label="付款状态"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="transactionAmount" label="成交金额"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        ...
        <el-table-column prop="cumulativePrepayment" label="累计预付"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="warehousePosition" label="仓位"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="lineExecutionStatus" label="行执行状态"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="lineStorageStatus" label="行入库状态"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="rowClosedStatus" label="行关闭状态"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="commodityPicture" label="商品图片"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="commodityCode" label="商品编码"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        ...
        <el-table-column prop="unitPriceIncludingTax" label="含税单价"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="taxAmount" label="税额"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="totalPriceAndTax" label="价税合计"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="detailsOfEstimatedPurchaseCosts" label="预计采购费用明细"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="specifications" label="规格"   width="150px"  align="center" sortable show-overflow-tooltip="" />
        <el-table-column prop="specification2" label="规格2"   width="150px"  align="center" sortable show-overflow-tooltip="" />
