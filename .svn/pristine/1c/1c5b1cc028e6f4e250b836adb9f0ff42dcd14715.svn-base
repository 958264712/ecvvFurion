    ...
    <el-card class="full-table" shadow="hover" style="margin-top: 8px">
      ...
      <el-table :data="tableData" size="large" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip="">
          <template #default="scope">
            <el-button icon="ele-Edit" size="small" text="" type="primary" @click="openEditMissionControl(scope.row)" > 编辑 </el-button>
            <el-button icon="ele-Delete" size="small" text="" type="primary" @click="delMissionControl(scope.row)" > 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
