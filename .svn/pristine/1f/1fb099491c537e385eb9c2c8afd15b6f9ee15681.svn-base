...
<template>
  <div class="oFSInventorySumAccount-container">
    ...
    <el-card class="full-table"  shadow="hover" style="margin-top: 8px;height: 700px; width: 1600px;">
      <el-table class="show_table" :data="tableData" size="large"  v-loading="loading" tooltip-effect="light" row-key="id" border="">
        ...
        <el-table-column prop="commodityInformationCostPrice" label="商品信息成本价"   align="center" width="150" sortable show-overflow-tooltip="" />
        ...
        <el-table-column prop="averageUnitPrice" label="平均单价-期末"   align="center" width="150" sortable show-overflow-tooltip="" />
